...
#define FACTOR_REHASH 10
#define FACTOR_CARGA_MAXIMO 0.5
#define DIVISOR_CLAVES 123456789
// #define MIN_TABLA 50000
...
hash_t *hash_crear(size_t capacidad)
{
	...
	// hash->capacidad = capacidad < MIN_TABLA ? MIN_TABLA : capacidad;
...
hash_t *hash_insertar(hash_t *hash, const char *clave, void *elemento, void **anterior)
{
	...
	// if ((int)hash->ocupados % 1000 == 0) printf("\nocupados hash: %i\n", (int)hash->ocupados);
	return hash;
}
